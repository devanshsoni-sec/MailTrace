...
Evidence demonstrates phishing or malicious activity.
...
## 29. Final Analyst Quality Check
...
## 30. Public Repository Review

Before committing a case to the public repository:

- Confirm malicious URLs and domains are defanged.
- Confirm secrets and credentials are absent.
- Confirm unnecessary personal information has been removed.
- Confirm screenshots contain no sensitive information.
- Confirm external sources are identified.
- Confirm unsupported compromise claims are removed.
- Confirm unnecessary raw malicious artifacts are excluded from public distribution.

This SOP is intended to provide a practical, repeatable phishing triage process suitable for SOC investigation workflows.